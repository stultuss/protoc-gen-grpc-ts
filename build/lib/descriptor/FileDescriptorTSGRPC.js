...
var FileDescriptorTSGRPC;
(function (FileDescriptorTSGRPC) {
    FileDescriptorTSGRPC.defaultServiceType = JSON.stringify({
        serviceName: '',
        methods: [],
    });
    FileDescriptorTSGRPC.defaultServiceMethodType = JSON.stringify({
        packageName: '',
        serviceName: '',
        methodName: '',
        requestStream: false,
    ...
    function print(fileDescriptor, entryMap) {
        ...
        fileDescriptor.getServiceList().forEach((service) => {
            let serviceData = JSON.parse(FileDescriptorTSGRPC.defaultServiceType);
            serviceData.serviceName = service.getName();
            service.getMethodList().forEach((method) => {
                let methodData = JSON.parse(FileDescriptorTSGRPC.defaultServiceMethodType);
    ...
    FileDescriptorTSGRPC.print = print;
})(FileDescriptorTSGRPC = exports.FileDescriptorTSGRPC || (exports.FileDescriptorTSGRPC = {}));
